  ...
  >
    ...
    >
      <div class="item__header">
        <p class="item__id">0{{ index + 1 }}</p>
        <img :src="require('../assets/img/smile' + index + '.png')" alt="smile-img">
      </div>

      <div class="item__body" v-show="itemParams.height > 160">
...
import itemBackground from "@/components/item-background";
